...
class MambaInnerFnNoOutProj(torch.autograd.Function):
    ...
    def backward(ctx, dout):
        ...
        # print("dx strides:", dx.stride())
        # print("dconv1d_out strides:", dconv1d_out.stride())

        # dx, dconv1d_weight, dconv1d_bias = causal_conv1d_cuda.causal_conv1d_bwd(
        #     x, conv1d_weight, conv1d_bias, dconv1d_out, None, dx, None, None, True, False  # Added None, None, False
        # )
